...
namespace beman {
    ...
    template<class Fp> class function_holder;
    template<class R, class... Args> 
    ...
    class copyable_function<R(Args...) _CONST _REF noexcept(_COPYABLE_FUNC_NOEXCEPT)> 
    {
        private: 
            ...
            template<class T> 
            static constexpr bool is_callable_from = _COPYABLE_FUNC_NOEXCEPT ? 
                (std::is_nothrow_invocable_r_v<R, T _CONST _REF, Args...> &&
                std::is_nothrow_invocable_r_v<R, T INVOKE_QUALS, Args...>)
                :  
                (std::is_invocable_r_v<R, T _CONST _REF, Args...> &&
                std::is_invocable_r_v<R, T INVOKE_QUALS, Args...>);
        public: 
            using result_type = R; 
...
} // namespace beman::copyable_function
